...
@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/ios-scaffold.md
...
@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes `TDD_MODE=true` (#4011 — MVP not required):** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/execute-mvp-tdd.md` (Read it). If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/templates/summary.md
