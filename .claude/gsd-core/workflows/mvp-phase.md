...
<required_reading>
@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/user-story-template.md
@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/spidr-splitting.md
@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
