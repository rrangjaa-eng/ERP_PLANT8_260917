...
```
Agent(
  prompt="Read F:/CLAUDE/ERP_PLANT8_260917/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/templates/SECURITY.md`
