...
ones). Reference: @F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / F:/CLAUDE/ERP_PLANT8_260917/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "F:/CLAUDE/ERP_PLANT8_260917/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @F:/CLAUDE/ERP_PLANT8_260917/.claude/gsd-core/templates/spec.md.
