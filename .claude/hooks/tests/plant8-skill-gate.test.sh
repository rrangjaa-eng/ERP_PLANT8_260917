...
# Phase 4 동작은 그대로: 인자 4 또는 인자 없음 → phase-04.log
projP6="$(new_project)"
P6="sid-dec-p4-$$"
...
expect_contains "Phase 4: review가 phase-04.log에" "$(gate_lines "$projP6" 04)" "review"
expect_contains "Phase 4: 인자 없는 세션 qa도 phase-04.log에" "$(gate_lines "$projP6" 04)" "qa"
