...
- [ ] **EXP-15**: 사람은 공급가액만 적는다. 지출결의·카드 사용·구매 요청에 증빙 종류(세금계산서·계산서·카드 전표·현금영수증·기타소득·사업소득·해외 인보이스 등, 코드표)를 고르면 종류별 세금 규칙(없음 / 부가세 가산율 / 원천징수율+면제 기준)에 따라 부가세 또는 원천징수액과 지급 총액을 서버가 계산해 보인다. 종류를 바꾸면 즉시 다시 계산된다. 규칙·세율은 이력형 설정이고 손익 비용은 공급가액 기준 그대로다
...
- [ ] **PNL-02**: 줄마다 가장 굳은 값 하나만 비용으로 든다: 증빙액 > 지출결의 승인액 > 견적 실행가. 진행 중에는 예상값이 든다. 목록·Excel·팀 합계는 우선순위 CASE 집계 1회로 계산하고 상세는 근거(trace)를 함께 만든다. '목록 합계 = 상세 합계' 테스트가 있다
...
**By phase:** 1 (9) · 2 (1) · 3 (13) · 4 (11) · 5 (13) · 6 (16) · 7 (6) · 8 (10) · 9 (5) · 10 (4)

---
*Requirements defined: 2026-09-17*
*Last updated: 2026-09-17 after /plan-ceo-review (23 findings + D3·D4·D5 + OV-1..8 folded in; OPS-06·OPS-07 added; OV-3 redefined → EXP-15 증빙 종류별 세금 자동 계산; CERT-01 QR 진입; 88/88 mapped to Phases 1-10)*
