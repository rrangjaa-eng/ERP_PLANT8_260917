...
**2026-09-24 페이즈 분리:** CERT-01·CERT-02와 D-1101~D-1103·D-1106~D-1108(행사 QR·당첨자 등록·수령자 제출·암호화·열람·파기·경영관리 정정·인쇄물·`/cso` 두 번)은 Phase 04.3 「QR 확인증 접수」로 옮겼고 결정은 `.planning/phases/04.3-qr-certificate-intake/04.3-CONTEXT.md`에 복사했다. 이 페이즈에는 경품 지출결의 연결(CERT-03, D-1104)·세금 제안(CERT-04, D-1105)·프로덕션 플래그 켜기가 남는다(`.planning/ROADMAP.md` Phase 11 기준 1·4). 아래 결정은 논의 기록으로 그대로 둔다.
...
### 이미 확정된 입력 (다시 묻지 않음 — 출처가 정본; 세금·지출결의 외 항목은 Phase 04.3으로 옮김)
...
### 범위·요구사항
- `.planning/ROADMAP.md` Phase 11 (Goal, 기준 1~4, 계좌 암호화 비고) — 2026-09-24 분리로 기준 2·3은 Phase 04.3 기준 2~5로 옮겼다 — 범위 정본(위 「로드맵 문구와 달라진 점」 셋은 이 문서가 대체)
