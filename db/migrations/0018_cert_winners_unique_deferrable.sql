-- 04.3-02 Task 1 ②-b(codex final3 A1 · C2) — cert_winners_event_id_name_phone_unique를
-- DEFERRABLE INITIALLY IMMEDIATE로 바꾼다. drizzle-kit이 이 절을 내지 못해
-- (unique() 빌더에 nullsNotDistinct()만 있음, drizzle-kit 0.31.10의
-- DEFERRABLE은 트랜잭션 옵션뿐) custom SQL로 만든다. Postgres 16의
