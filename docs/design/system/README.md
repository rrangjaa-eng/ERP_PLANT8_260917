...
다시 찍기: Playwright(chromium)로 `preview.html`을 1280×900 · 390×844(isMobile)로, `print-expense.html`을 900×1200으로 fullPage 캡처. `sheet-modal.html`은 해시별로 390×844(isMobile) · 1280×800 뷰포트 캡처(fullPage 아님, 시트가 fixed).
