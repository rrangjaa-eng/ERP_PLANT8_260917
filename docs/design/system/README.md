...
| `dashboard-pnl.html` · `external-cert.html` | **§6 남은 실물 2개 초안(2026-09-18) — 보드로 사용자 확인 전, 미확정.** 해시로 장면 선택(파일 머리 주석). SYSTEM.md에 없어서 임시로 정한 것은 `NEXT-SESSION.md` C 참고 |
...
| `shots/pnl-*.png` · `shots/cert-*.png` | 손익 원장 · 외부 수령자 초안(미확정) |
