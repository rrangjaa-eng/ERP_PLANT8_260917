...
export function Shell({ topBarMenu, systemStatus, accountGroup, bottomTabs, userName, children }: ShellProps) {
  return (
    <div className={styles.shell}>
      ...
      <TopBar topBarMenu={topBarMenu} systemStatus={systemStatus} accountGroup={accountGroup} userName={userName} />
